...
const buttonStyles = css<IProps>`
  ...
  ${({ $variant, disabled }) =>
    ...
    css`
      ...
      &:hover {
        background: ${({ theme }) => theme.colors.btnBackgroundVariant1000};
      }
      &:active {
        background: ${({ theme }) => theme.colors.btnBackgroundVariant700};
  ...
  ${({ $variant }) =>
    ...
    css`
      ...
      &:active {
        svg {
          fill: ${({ theme }) => theme.colors.btnBackgroundVariant1400};
        }
      }
    `};
  ${({ $variant, disabled }) =>
