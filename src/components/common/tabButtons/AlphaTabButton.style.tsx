...
const buttonStyles = css<IProps>`
  ...
  &:hover {
    background-color: ${({ theme }) => theme.colors.btnBackgroundVariant1000};
  }
  &:active {
    background-color: ${({ theme }) => theme.colors.btnBackgroundVariant300};
  }
  ...
  ${({ $variant }) =>
    ...
    css`
      ...
      line-height: 17px;
      border: 0;
      background-color: ${({ theme }) => theme.colors.btnBackgroundVariant1100};
      &:hover {
  ...
  ${({ $open, $variant }) =>
    ...
    css`
      ...
      background-color: ${({ theme }) => theme.colors.btnBackgroundVariant1400};
      border-color: ${({ theme }) =>
  ...
  &.portfolio-addWallet {
    ...
    background-color: ${({ theme }) => theme.colors.btnBackgroundVariant1200};
    &:hover {
      background-color: ${({ theme }) => theme.colors.btnBackgroundVariant1100};
    }
  }
