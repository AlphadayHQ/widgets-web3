...
describe("accountExists", () => {
    it("should return true if account exists", () => {
        ...
        const nonNormalisedddr = hexAcc0
            ? hexAcc0.slice(0, 2) +
...
describe("syncAccounts", () => {
    ...
    const syncedAccounts = syncAccounts(localAccounts, remoteAccounts);
    it("should correctly sync local and remote accounts", () => {
        expect(syncedAccounts.length).toEqual(3);
        expect(syncedAccounts[0].id).toEqual(0);
        expect(syncedAccounts[2].address).toEqual(
